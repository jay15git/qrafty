...
export type DraftingShortcutHandlers = {
  ...
  handleLayerAction: (paneId: string, layerIds: string[], action: DraftingLayerMenuAction) => void;
  handleLayerChange: (paneId: string, layerId: string, patch: Partial<DraftingCanvasLayer>) => void;
