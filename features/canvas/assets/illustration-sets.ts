export type IllustrationSetId =
  "scribbles-doodles" | "sketch-elements" | "vector-sticker-pack" | "hand-drawn";
...
export const ILLUSTRATION_SETS: readonly IllustrationSet[] = [
  {
    ...
    assets: [
      ...
      },
      {
        ...
        label:
          "arrow, hand drawn, scribble, doodle, down, curvy, curly, up, right, loop, swirl, 73",
      },
      {
      ...
      },
      {
        ...
        label:
          "arrow, hand drawn, scribble, doodle, shaded, thick, arrows, reload, refresh, load, repeat, 89",
      },
      {
      ...
      },
      {
        ...
        label:
          "arrow, hand drawn, scribble, doodle, thick, lightning, reload, return, refresh, rounded, arrows, 63",
      },
      {
