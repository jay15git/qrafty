...
describe("canvas-layer-chrome-overlay", () => {
  ...
  it("places the toolbar above the frame and flips below near the top edge", () => {
    const above = getFloatingLayerToolbarPosition({
    ...
    const flipped = getFloatingLayerToolbarPosition({
  ...
  it("clamps the toolbar horizontally to the visible canvas", () => {
    const position = getFloatingLayerToolbarPosition({
