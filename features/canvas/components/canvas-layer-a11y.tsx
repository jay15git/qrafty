...
function getCanvasLayerA11yLabel(layer: CanvasLayer) {
...
export function CanvasLayerInteractive({
  layer,
  isSelected,
  onActivate,
  className,
...
type CanvasWorkspaceInteractiveProps = Omit<ComponentPropsWithoutRef<"div">, "ref"> & {
  label: string;
  onActivate: () => void;
};

export const CanvasWorkspaceInteractive = forwardRef<
  HTMLDivElement,
  CanvasWorkspaceInteractiveProps
>(function CanvasWorkspaceInteractive(
