...
export const INSERT_MENU_TEXT_PREVIEWS: InsertMenuFanPreviewItems = [
  <InsertMenuTextPreviewCard
    key="text-serif"
    className="font-serif text-base font-semibold leading-none tracking-tight text-[var(--fg)]"
  >
    Aa
  </InsertMenuTextPreviewCard>,
  <InsertMenuTextPreviewCard
    key="text-sans"
    className="font-sans text-base font-bold leading-none tracking-tight text-[var(--fg)]"
  >
    Bb
  </InsertMenuTextPreviewCard>,
  <InsertMenuTextPreviewCard
