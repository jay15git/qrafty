...
export const INSERT_MENU_POPOVER_SHELL =
  "dn-insert-menu-popover dn-portal-surface z-[20000] overflow-hidden border-0 bg-transparent p-0 text-[var(--fg)] shadow-none outline-none dn-squircle-md"

export const INSERT_MENU_SCROLL_CLASS = "dn-insert-menu-scroll h-[min(20rem,60dvh)]"

export const INSERT_MENU_ROOT_SCROLL_CLASS = "dn-insert-menu-root-scroll max-h-[min(20rem,60dvh)] w-full min-w-0"
