...
vi.mock("@/features/qr/rendering/qrafty-markup", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("@/features/qr/rendering/qrafty-markup")>()
...
import { RESIZE_CONTROL_PADDING_PX, ROTATE_HANDLE_OFFSET_PX, ROTATE_HANDLE_RADIUS_PX, ROTATE_LABEL_GAP_PX } from "@/features/canvas/components/pane-layer-chrome.constants"
