...
export type ElementControllerParams = {
  ...
  onLayerChange: (nodeId: string, layerId: string, patch: Partial<DraftingCanvasLayer>) => void;
...
export type LayersControllerParams = {
  ...
  onLayerAction: (nodeId: string, layerIds: string[], action: DraftingLayerMenuAction) => void;
  onLayerCopy: () => void;
  onLayersReset: () => void;
