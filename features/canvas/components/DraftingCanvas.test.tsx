...
describe("DraftingCanvas", () => {
  it("deletes removable selected layers from the floating canvas toolbar", async () => {
    ...
    expect(
      canvas.container.querySelector('[data-slot="drafting-text-layer"]')?.getAttribute("data-selected"),
    ).toBe("true")
    ...
    expect(canvas.container.querySelector('[data-slot="drafting-layer-floating-toolbar"]')).toBeNull()
  })
  ...
  it("renders the desktop chrome across the dynamic island, utility toolbar, and settings panel", async () => {
    ...
    expect(getRequiredElement(settingsFooter, '[data-slot="keyboard-shortcuts-trigger"]')).not.toBeNull()
    expect(getRequiredElement(settingsFooter, '[data-slot="theme-toggle"]').getAttribute("aria-label")).toBe("Switch to light mode")
    ...
    expect(canvas.container.querySelector('[data-slot="desktop-compose-toolbar-anchor"]')).toBeNull()
  ...
  it("does not expose the dashboard edit mode toggle or edit rail on drafting", async () => {
    ...
    expect(canvas.container.querySelector('[data-slot="drafting-edit-nav-scroll-area"]')).toBeNull()
  ...
  it("adds a fresh qr layer from the bottom toolbar and selects it", async () => {
    ...
    expect(canvas.container.querySelectorAll('[data-slot="desktop-compose-surface"]')).toHaveLength(1)
  ...
  it("focuses the drafting canvas after selecting a canvas layer", async () => {
    ...
    const draftingCanvas = getRequiredElement(
      canvas.container,
