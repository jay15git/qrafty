...
export type DraftingLayerInteractionProps = {
  onLayerChange?: (paneId: string, layerId: string, patch: Partial<DraftingCanvasLayer>) => void;
  onLayerAction?: (paneId: string, layerIds: string[], action: DraftingLayerMenuAction) => void;
