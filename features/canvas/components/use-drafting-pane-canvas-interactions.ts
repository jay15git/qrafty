...
import type { DraftingPane, DraftingPaneCanvasTool } from "@/features/canvas/components/DraftingPaneCanvas"
...
import { ENTRANCE_COMPLETE_EVENT, ENTRANCE_PRE_REVEAL_EVENT } from "@/features/shell/components/WorkspaceEntrance"
...
type UseDraftingPaneCanvasInteractionsArgs = {
...
export function useDraftingPaneCanvasInteractions({
  activeCanvasTool,
...
}: UseDraftingPaneCanvasInteractionsArgs) {
  ...
  const isFreeEditWorkspace =
    toolbarVariant === "zoom" && layerEditingEnabled && !previewLocked
