...
export const LAYER_TOOLBAR_GAP_PX = 8;
export const LAYER_TOOLBAR_HEIGHT_PX = 48;
export const LAYER_TOOLBAR_MIN_WIDTH_PX = 192;
export const LAYER_TOOLBAR_EDGE_GUTTER_PX = 8;
export const RESIZE_SNAP_THRESHOLD_PX = 3;
export const CONTEXT_MENU_POINTER_OFFSET_PX = 8;

const RESIZE_CORNER_HANDLE_SIZE_PX = 8;
