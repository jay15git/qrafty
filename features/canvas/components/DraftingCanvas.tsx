...
import { Canvas, type DraftingPaneToolbarVariant } from "@/features/canvas/components/Canvas";
import type {
  ThemeMode,
  ToolbarController,
  ToolbarToolId,
...
export function DraftingCanvas({
  ...
  return (
    ...
    >
      ...
      <div data-slot="drafting-content-grid" className="min-h-0 min-w-0 block h-full">
        <section
        ...
        >
          <div data-slot="drafting-workspace-inset" className="h-full min-h-0 p-0">
            <div data-slot="desktop-canvas-viewport" className="h-full min-h-0 min-w-0">
              {isDraftingWorkspaceReady ? (
                <Canvas
