...
import { findDraftingLayerById } from "@/features/canvas/components/workspace-surface-helpers"
...
/**
 * Pure derivations for the workspace surface view model. No React, no DOM —
...
export function resolveQrBackgroundSurfaceVisible(draftingQraftyState: QraftyState) {
  return (
...
export function resolveDesktopLayerTargets(
  activeCanvasLayers: DraftingCanvasLayer[],
  selectedLayerIds: string[],
...
export function resolveDesktopAppearanceSnapshot(
