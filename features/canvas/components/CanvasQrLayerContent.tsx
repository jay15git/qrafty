...
type CanvasQrLayerContentProps = {
  ...
  overlayScale?: number;
  /** SVG markup already sanitized by useCanvasQrMarkup (DOMPurify) upstream. */
...
export const CanvasQrLayerContent = memo(function CanvasQrLayerContent({
  canvasSvgMarkup,
  layer,
  overlayMessage,
  overlayScale,
    ...
    return (
      <div className="relative h-full w-full" style={shapeTiltPerspectiveStyle}>
        <div className="relative h-full w-full" style={shapeTiltInnerStyle}>
          <CanvasQrBackground layer={layer} state={state} />
