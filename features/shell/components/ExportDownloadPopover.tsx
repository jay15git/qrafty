  ...
  return (
    <Popover modal={false} open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        ...
        sideOffset={12}
        className={cn(
          "dn-portal-surface inspector-popover-content dn-popover-flat z-[20000] grid max-h-[min(28rem,calc(100dvh-8rem))] w-[min(18rem,calc(100vw-1rem))] grid-rows-[minmax(0,1fr)] overflow-hidden p-0 dn-squircle-md",
          theme === "dark" && "dark",
        )}
      >
        <ScrollArea
