...
import {
  MobileColorRailFooter,
  MobileColorRailRow,
} from "./mobile-settings-rail/rows/color"
import { MobileMotionRailRow } from "./mobile-settings-rail/rows/motion"
import {
  MobileQrRailFooter,
  MobileQrRailRow,
} from "./mobile-settings-rail/rows/qr"
import {
  MobileShapeRailFooter,
  MobileShapeRailRow,
} from "./mobile-settings-rail/rows/shape"
...
export function MobileSettingsRail({ model }: { model: InspectorModel }) {
  ...
  const { fading, railModeContext, railPartContext, setOpenPart, viewFamily } =
    useRailViewState(openFamily, model, MOBILE_FAMILY_FOOTERS)
