...
} from "@/features/shell/inspector/settings-sections"
import { DesktopnewThemeContext } from "@/features/shell/inspector/theme-context"
import { setInspectorSectionTab } from "@/features/shell/inspector/inspector-chrome-state"
import {
...
import { DESKTOP_DOTS_PALETTE_PRESETS } from "@/features/shell/inspector/pattern-palettes"
import { PaletteColorBarPreview } from "@/features/shell/inspector/palette-color-bar-preview"
...
} from "@/features/shell/inspector/settings-preview-tiles"
...
const LazyDesktopFillPicker = lazy(() =>
  import("@/features/shell/inspector/fill-picker").then(
...
const LazySettingsImageUploadTile = lazy(() =>
  import("@/features/shell/inspector/settings-fill-option-grid").then(
...
const LazyPatternColorPickerContent = lazy(() =>
  import("@/features/shell/inspector/qr-color-fill-controls").then(
