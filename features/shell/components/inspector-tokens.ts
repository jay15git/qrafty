...
export const INSPECTOR_CONTROL_HEIGHT_CLASS =
...
export const INSPECTOR_RADIUS_CLASS =
  "rounded-[length:var(--settings-radius)]"

const INSPECTOR_FG_SECONDARY =
  "text-[var(--settings-fg-secondary)]"
const INSPECTOR_FG_MUTED =
  "text-[var(--settings-fg-muted)]"
export const INSPECTOR_TYPE_VALUE_CLASS =
  "text-[length:var(--settings-type-value)] leading-[1.45]"
const INSPECTOR_TYPE_LABEL_CLASS =
  "text-[length:var(--settings-type-label)]"
const INSPECTOR_TYPE_CAPTION_CLASS =
  "text-[length:var(--settings-type-caption)]"
export const INSPECTOR_SECTION_HEADING_CLASS =
  cn(
