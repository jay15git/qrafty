...
export const SETTINGS_CONTROL_HEIGHT_CLASS = "h-[length:var(--control-height)]";
export const SETTINGS_CONTROL_HEIGHT_COMPACT_CLASS = "h-[length:var(--control-height-compact)]";
export const SETTINGS_RADIUS_CLASS = "rounded-[length:var(--radius-control)]";
...
export const SETTINGS_CAPTION_CLASS = cn(
  "font-medium text-[var(--fg-muted)]",
  SETTINGS_TYPE_CAPTION_CLASS,
);
export const SETTINGS_SECTION_GAP_CLASS = "mt-2";
const SETTINGS_ROW_GAP_CLASS = "gap-[length:var(--space-inline)]";
...
export const SETTINGS_LABEL_CLASS = cn(
...
export const SETTINGS_SELECTED_CLASS =
...
export const SETTINGS_INPUT_CLASS = cn(
...
export const SETTINGS_OPTION_TILE_SURFACE_CLASS = cn(
...
export const SETTINGS_OPTION_TILE_SCALE_PREVIEW_CLASS = "";
export const SETTINGS_LAYER_ROW_SELECTED_CLASS =
  "bg-[var(--option-selected-bg)] text-[var(--option-selected-fg,var(--fg-primary))]";
export const SETTINGS_LAYER_ACTION_CLASS = cn(
...
export const SETTINGS_POPOVER_HEADER_CLASS =
