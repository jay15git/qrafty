...
export const LazyInspectorFillPicker = lazy(() =>
  import("@/features/shell/inspector/FillPicker").then(
    (module) => ({ default: module.InspectorFillPicker }),
  ),
)
export type { LockedFillPickerMode }

export const LazyLayersPopoverContent = lazy(() =>
  import("@/features/shell/components/LayersPopoverContent").then(
    (module) => ({ default: module.LayersPopoverContent }),
  ),
)
...
export const LazySettingsImageUploadTile = lazy(() =>
  import("@/features/shell/inspector/SettingsFillOptionGrid").then(
...
export const LazyPatternColorPickerContent = lazy(() =>
  import("@/features/shell/inspector/QrColorFillControls").then(
