...
describe("SettingsFillPicker", () => {
  ...
  it("switches to the gradient pane without a hooks crash", () => {
    ...
    function Harness() {
      ...
      return <SettingsFillPicker value={value} onValueChange={(_fill, css) => setValue(css)} />;
    }
  ...
  it("opens on the gradient tab when the value is a gradient", () => {
    ...
    act(() => {
      root.render(<SettingsFillPicker value={css} onValueChange={() => undefined} />);
    });
