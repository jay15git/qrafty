...
import { FillPickerPortalSurfaceProvider } from "@/components/ui/fill-picker/base/contexts/portal-surface";
import { FillPicker } from "@/components/ui/fill-picker/base/fill";
import { GradientPicker } from "@/components/ui/fill-picker/base/gradient";
...
import { GradientInterpRow, GradientTypeRow } from "@/features/shell/settings/GradientControls";
...
export function SettingsFillPicker({
  value,
  onValueChange,
  className,
  modulePattern,
