...
vi.mock("@/features/shell/settings/FillPicker", () => ({
  SettingsFillPicker: ({
    value,
    onValueChange,
    solidOnly,
...
vi.mock("@/features/shell/settings/settings-ui", async (importOriginal) => {
  const React = await import("react");
  const { SettingsFillOptionGrid } =
    await import("@/features/shell/settings/SettingsFillOptionGrid");
  const actual = await importOriginal<typeof import("@/features/shell/settings/settings-ui")>();
