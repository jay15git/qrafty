...
import { isGradientFill } from "@/features/shell/inspector/fill-picker.utils"
  ...
  return (
    ...
    >
      <span aria-hidden className={SETTINGS_FILL_OPTION_TILE_INNER}>
        ...
        >
          {customValue ? (
            <span className="grid size-5 place-items-center rounded-full bg-[color-mix(in_srgb,var(--bg)_85%,transparent)] text-[var(--fg)]">
