 ...
 */
export function MobileOptionRail({
  activeKey,
  ariaLabel,
  children,
  persistKey,
 ...
 */
export function MobileOptionShelf({
  activeKey,
  ariaLabel,
  children,
  columns = 6,
  ...
  if (mobileDensity) {
    return (
      <div className="ds-settings-shelf" data-slot={dataSlot}>
        ...
        <MobileOptionRail activeKey={activeKey} ariaLabel={ariaLabel} persistKey={persistKey}>
          {children}
        </MobileOptionRail>
      </div>
    );
...
export function MobileOptionCardRail({
  ariaLabel,
  children,
  persistKey,
}: {
