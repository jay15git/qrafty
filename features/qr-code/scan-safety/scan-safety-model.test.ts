...
import {
  ...
  getQraftyQrModuleGrid,
} from "@/features/qr-code/scan-safety/qr-grid"
import decodeQR from "qr/decode.js"
import {
  getTransformedLayerBounds,
  resolveQrScanRegion,
} from "@/features/qr-code/scan-safety/scan-region"
...
describe("qr decode", () => {
  it("decodes a rendered QR back to its payload", () => {
    expect(decodeQR(renderQrImage("https://qrafty.app"))).toBe(
      "https://qrafty.app",
    )
  })
