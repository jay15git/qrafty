...
import { detectPastedContent, detectUrlKind } from "@/features/qr/content/detect-url-kind";
...
describe("detectPastedContent", () => {
  it("detects URI scheme payloads before URL rules", () => {
    ...
    expect(detectPastedContent("upi://pay?pa=merchant@okaxis&pn=New%20QR&am=10&cu=INR")).toEqual({
      kind: "upi",
