...
export function resolveStructuredPasteApply(input: string): ContentPasteApplyResult | null {
...
export function getDetectionChipLabel(detection: UrlDetection): string {
  const platformDef = detection.inputTypeHint ? getPlatformDef(detection.inputTypeHint) : undefined;
...
function mapStructuredPaste(detection: PastedContentDetection): ContentPasteApplyResult | null {
