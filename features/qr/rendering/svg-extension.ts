...
} from "./svg-extension/types"
import {
  getActiveDotsPalette,
} from "./svg-extension/dot-matrix-palette"
import {
...
} from "./svg-extension/background-image"
...
export { getQrRenderedDimensions, getDraftingQrLayerLayout, getDraftingQrDomPlacementStyle, getDraftingQrBackgroundPathTransform, getQrSvgNumCells } from "./svg-extension/background-shape-layout"
export { getFinderCornerRegions, createAlignedCornerGradientExtension } from "./svg-extension/finder-corner-gradient"
