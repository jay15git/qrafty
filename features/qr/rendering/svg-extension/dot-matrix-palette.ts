...
export function compareDotPaletteShapeGroups(left: DotPaletteShapeGroup, right: DotPaletteShapeGroup) {
...
export function getDotPaletteIndex(group: DotPaletteShapeGroup, paletteLength: number, seed: number) {
  if (paletteLength <= 0) {
    return 0
  }
