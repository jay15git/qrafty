...
import { StylePreview } from "@/features/qr/components/StylePreview";
import { getModuleStylePreviewViewBox } from "@/features/qr/styles/style-preview";

describe("StylePreview", () => {
  it("renders module previews from a synthetic art-directed module grid", () => {
    const markup = renderToStaticMarkup(<StylePreview previewKind="dots" value="circuit-board" />);
  ...
  it("renders custom dot previews through the real qr renderer", () => {
    const diamondMarkup = renderToStaticMarkup(<StylePreview previewKind="dots" value="diamond" />);
    const heartMarkup = renderToStaticMarkup(<StylePreview previewKind="dots" value="heart" />);
  ...
  it("renders corner-dot previews from a real qr code, cropped to the inner finder dot", () => {
    ...
    const leafMarkup = renderToStaticMarkup(<StylePreview previewKind="corner-dot" value="leaf" />);
