...
export const DESKTOP_GLASS_TOOLBAR_ICON_BUTTON_ACTIVE_CLASS =
  "text-[var(--desktop-glass-button-hover-fg)] opacity-100"

export const DESKTOP_BOXED_TOOLBAR_ICON_CLASS = "size-5 shrink-0"

export const DESKTOP_BOXED_TOOLBAR_BUTTON_CLASS = "[&_svg]:!size-5"
