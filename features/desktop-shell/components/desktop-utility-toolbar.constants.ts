export const DESKTOP_UTILITY_TOOLBAR_SHELL_CLASS =
  "inline-flex min-h-11 items-center gap-1 border-0 bg-transparent p-0 text-[var(--desktop-glass-fg)] shadow-none"

const DESKTOP_GLASS_TOOLBAR_ICON_BUTTON_CLASS =
...
const DESKTOP_BOXED_TOOLBAR_ICON_CLASS = "size-5 shrink-0"

const DESKTOP_BOXED_TOOLBAR_BUTTON_CLASS = "[&_svg]:!size-5"


const DESKTOP_COMPOSE_TOOLBAR_ICON_BUTTON_CLASS = DESKTOP_GLASS_TOOLBAR_ICON_BUTTON_CLASS
