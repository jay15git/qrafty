...
export const MatterBody = ({
  ...
  }, [angle, bodyType, context, isDraggable, matterBodyOptions, sampleLength, x, y])
  ...
  (
    ...
    const registerElement = useCallback(
      (id: string, element: HTMLElement, bodyProps: MatterBodyProps) => {
        ...
        const bodyX = calculatePosition(bodyProps.x, canvasRect.width, width)
        const bodyY = calculatePosition(bodyProps.y, canvasRect.height, height)

        let body
        if (bodyProps.bodyType === "circle") {
          const radius = Math.max(width, height) / 2
          body = Bodies.circle(bodyX, bodyY, radius, {
          ...
          body = Bodies.fromVertices(bodyX, bodyY, vertexSets, {
            ...bodyProps.matterBodyOptions,
            angle: bodyAngle,
            render: {
              fillStyle: debug ? "#888888" : "#00000000",
          ...
          body = Bodies.rectangle(bodyX, bodyY, width, height, {
            ...bodyProps.matterBodyOptions,
            angle: bodyAngle,
            render: {
              fillStyle: debug ? "#888888" : "#00000000",
