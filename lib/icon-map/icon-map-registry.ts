...
import {
  ...
  IconSquare,
  IconCircle,
  IconLibrary as IconLibraryIcon,
  IconClock,
  IconStar,
  IconSettings,
  IconPlus,
...
import { hugeicons } from "./adapters/create-hugeicons-icon";
import { phosphor } from "./adapters/create-phosphor-icon";
import { tabler } from "./adapters/create-tabler-icon";
import { untitledui } from "./adapters/create-untitledui-icon";
import type { IconComponent, IconLibrary, IconName } from "./types";
...
const tablerMap: Record<IconName, IconComponent> = {
  ...
  "square-library": tabler(IconLibraryIcon),
